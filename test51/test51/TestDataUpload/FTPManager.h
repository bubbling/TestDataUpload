...
#define kFMProcessInfoProgress @"progress"
...
/**
 *  Creates more then one folder on the specified FTP server.
 *
 *  @param foldersPath The path of the folders to create.
 *  @param server     The FTP server on which the new folder should be created.
 *
 *  @return YES if the folder creation was successful, NO otherwise.
 */
